...
import { tryCatch } from '@/types/utils';
...
function DescriptionRoot() {
  ...
  const { EmployeeData, isLoading, ErrorEmployee, isError } = useEmployeeData();
          ...
          {modalState.selectedItem && modal && (
            <div className="fixed inset-0 z-50 flex">
              ...
              <RootModal
                ...
                dataAvailableOnboarding={dataAvailableOnboarding}
                dataAvailableOffboarding={dataAvailableOffboarding}
                setDataAvailableOnboarding={setDataAvailableOnboarding}
                setDataAvailableOffboarding={setDataAvailableOffboarding}
