...
function MaddoxDescription({ className, ...props }) {
...
export { Item, ItemMedia, ItemContent, ItemActions, ItemGroup, ItemSeparator, ItemTitle, MaddoxDescription, ItemHeader, ItemFooter, };
