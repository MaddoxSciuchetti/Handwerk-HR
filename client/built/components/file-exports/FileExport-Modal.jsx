...
export function FileModal({ id, onClose, form_type }) {
    ...
    const MyDocument = () => (<Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.content}>
          {data?.form?.fields?.map((field, index) => (<View key={index} style={styles.fieldContainer}>
    ...
    return (<>
      ...
      <div className="relative min-h-50 max-h-150 mt-40 mx-auto text-center items-center z-50 bg-gray-200 rounded-xl  w-2xl">
        <div className="flex items-center gap-10 justify-center mb-6 m-10">
          ...
          <Button variant={"outline"} className="hover:bg-gray-300 absolute top-135" onClick={handleExport}>
            Exporieren
          </Button>
        </div>
      </div>
