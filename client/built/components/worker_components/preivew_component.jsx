...
function PreviewComponent({ toggleModal, id, description, editcomment, select_option, form_field_id, handleSubmit, }) {
    ...
    return (<>
      <div className="max-h-min mt-40 mx-auto text-center items-center z-50 bg-gray-200 rounded-xl w-2xl">
        <div className="flex items-center gap-10 justify-center mb-6 m-10 ">
          <form className="flex flex-col gap-5  w-full" onSubmit={handleSubmit} name="valuesform">
            ...
            <Textarea defaultValue={editcomment} id="editcomment" name="editcomment" className="w-xl"/>
            ...
            <div className="flex flex-row gap-2">
              <div>
                <Select value={selectedValue} onValueChange={setSelectedValue}>
                  <SelectTrigger id="status" name="select_option" value={select_option} className={selectedValue === "erledigt"
            ...
            : selectedValue === "offen"
                ...
                : selectedValue === "in_bearbeitung"
                  ...
                  <SelectContent className="border-none">
                    <SelectGroup className="bg-white cursor-pointer">
                      <SelectItem className="hover:bg-gray-200 cursor-pointer" id="select1" value="offen">
                        Offen
                      </SelectItem>
                      <SelectItem className="hover:bg-gray-200 cursor-pointer" id="select2" value="in_bearbeitung">
                        In Bearbeitung
                      </SelectItem>
                      <SelectItem className="hover:bg-gray-200 cursor-pointer" id="select3" value="erledigt">
                        Erledigt
                      </SelectItem>
                    </SelectGroup>
                  </SelectContent>
              ...
              <div>
                <Button className="w-[17.75rem] hover:bg-gray-300" variant={"outline"} type="submit">
                  Speichern
                </Button>
              </div>
            </div>
