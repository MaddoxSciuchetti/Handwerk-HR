...
const Profile = () => {
    ...
    if (isError || !user) {
        return (<div className="flex flex-col items-center mt-16 space-y-2">
    ...
    return (<div className="flex flex-col items-center mt-16 space-y-4 ">
      <h1 className="text-3xl font-bold mb-4">My Account</h1>
      {!verified && (<Alert variant="default" className="w-fit rounded-xl mb-3 border-yellow-200 bg-yellow-50">
