...
const ResetPassword = () => {
    ...
    return (<div className="min-h-screen flex justify-center">
      <div className="mx-auto max-w-md py-12 px-6 text-center">
        {linkIsValid ? (<ResetPasswordForm code={code}/>) : (<div className="flex flex-col items-center space-y-4">
            ...
            <button onClick={() => navigate({ to: "/password/forgot" })} className="text-blue-600 hover:text-blue-800 underline">
